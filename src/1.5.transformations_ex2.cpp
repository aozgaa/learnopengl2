...
const char *vertexShaderPath   = "src/1.5.transformations_ex2.vert";
const char *fragmentShaderPath = "src/1.5.transformations_ex2.frag";
...
int main() {
  ...
  while (!glfwWindowShouldClose(window)) {
    ...
    transform =
        glm::rotate(transform, (float)glfwGetTime(), glm::vec3(0.0, 0.0, 1.0));
    ...
    transform   = glm::mat4(1.0f);
    transform   = glm::translate(transform, glm::vec3(-0.5f, 0.5f, 0.0f));
    float scale = glm::sin(glfwGetTime()) + 1.0f;
