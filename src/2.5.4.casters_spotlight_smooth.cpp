...
const char *cubeFragmentShaderPath  = "src/2.5.4.casters_spotlight_smooth_cube.frag";
...
int main() {
  ...
  while (!glfwWindowShouldClose(window)) {
    ...
    glUniform1f(cube.locs.light.spotlightCosInner, glm::cos(glm::pi<float>() * 0.1));
    glUniform1f(cube.locs.light.spotlightCosOuter, glm::cos(glm::pi<float>() * 0.2));
