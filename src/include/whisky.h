...
constexpr static uint32_t whisky1(uint32_t i0) {
  uint32_t z0 =
      static_cast<uint32_t>((static_cast<uint64_t>(i0) * 1831267127U) ^ i0);
  uint32_t z1 = static_cast<uint32_t>(
      (static_cast<uint64_t>(z0) * 3915839201U) ^ (z0 >> 20));
  uint32_t z2 = static_cast<uint32_t>(
      (static_cast<uint64_t>(z1) * 1561867961U) ^ (z1 >> 24));
  return z2;
}
...
constexpr static uint32_t whisky4(uint32_t i0, uint32_t i1, uint32_t i2,
                                  uint32_t i3) {
...
constexpr static uint32_t whisky4alt(uint32_t i0, uint32_t i1, uint32_t i2,
                                     uint32_t i3) {
...
constexpr static uint32_t whisky5(uint32_t i0, uint32_t i1, uint32_t i2,
...
constexpr static uint32_t whisky5alt(uint32_t i0, uint32_t i1, uint32_t i2,
                                     uint32_t i3, uint32_t i4) {
...
constexpr static uint32_t whisky5alt2(uint32_t i0, uint32_t i1, uint32_t i2,
                                      uint32_t i3, uint32_t i4) {
...
constexpr static void whiskySha256(const uint32_t input[8],
  ...
  uint32_t x, y,
      m[64] = { input[0], input[1], input[2],   input[3], input[4], input[5],
...
constexpr static float whisky4f(uint32_t i0, uint32_t i1, uint32_t i2,
                                uint32_t i3) {
  return whiskyf(whisky4(i0, i1, i2, i3));
}
constexpr static double whisky4d(uint32_t i0, uint32_t i1, uint32_t i2,
                                 uint32_t i3) {
  return whiskyd(whisky4(i0, i1, i2, i3), whisky4alt(i0, i1, i2, i3));
}
constexpr static float whisky5f(uint32_t i0, uint32_t i1, uint32_t i2,
                                uint32_t i3, uint32_t i4) {
  return whiskyf(whisky5(i0, i1, i2, i3, i4));
}
constexpr static double whisky5d(uint32_t i0, uint32_t i1, uint32_t i2,
                                 uint32_t i3, uint32_t i4) {
