...
constexpr static uint32_t whisky1(uint32_t i0) {
  uint32_t z0 = static_cast<uint32_t>((static_cast<uint64_t>(i0) * 1831267127U) ^ i0);
  uint32_t z1 =
      static_cast<uint32_t>((static_cast<uint64_t>(z0) * 3915839201U) ^ (z0 >> 20));
  uint32_t z2 =
      static_cast<uint32_t>((static_cast<uint64_t>(z1) * 1561867961U) ^ (z1 >> 24));
  return z2;
}
...
constexpr static uint32_t whisky1alt(uint32_t i0) {
...
constexpr static uint32_t whisky1alt2(uint32_t i0) {
  uint32_t z0 = (i0 * 270324709) ^ i0;
  uint32_t z1 = (z0 * 1880041297) ^ (z0 >> 17);
  uint32_t z2 = (z1 * 1591606349) ^ (z1 >> 24);
  return z2;
}

constexpr static uint32_t whisky2(uint32_t i0, uint32_t i1) {
...
constexpr static uint32_t whisky2alt(uint32_t i0, uint32_t i1) {
...
constexpr static uint32_t whisky2alt2(uint32_t i0, uint32_t i1) {
  uint32_t z0 = (i0 * 2627356049) ^ i1;
  uint32_t z1 = (z0 * 378291119) ^ i1;
  uint32_t z2 = (z1 * 357846343) ^ (z1 >> 18);
  uint32_t z3 = (z2 * 144068209) ^ z0;
  uint32_t z4 = (z3 * 1883673907) ^ (z3 >> 17);
  return z4;
}

constexpr static uint32_t whisky3(uint32_t i0, uint32_t i1, uint32_t i2) {
...
constexpr static uint32_t whisky3alt(uint32_t i0, uint32_t i1, uint32_t i2) {
...
constexpr static uint32_t whisky3alt2(uint32_t i0, uint32_t i1, uint32_t i2) {
...
constexpr static uint32_t whisky4(uint32_t i0, uint32_t i1, uint32_t i2, uint32_t i3) {
...
constexpr static uint32_t whisky4alt(uint32_t i0, uint32_t i1, uint32_t i2, uint32_t i3) {
...
constexpr static uint32_t whisky4alt2(uint32_t i0, uint32_t i1, uint32_t i2,
                                      uint32_t i3) {
  uint32_t z0 = (i1 * 895359197) ^ (i0 >> 21) ^ i0;
  uint32_t z1 = (i3 * 275340049) ^ z0;
  uint32_t z2 = (i2 * 2503964471) ^ z1;
  uint32_t z3 = (z2 * 377898251) ^ (z2 >> 21) ^ z2;
  uint32_t z4 = (z3 * 400831931) ^ (z3 >> 16);
  uint32_t z5 = (z4 * 1732967161) ^ (z4 >> 20);
  return z5;
}

constexpr static uint32_t whisky5(uint32_t i0, uint32_t i1, uint32_t i2, uint32_t i3,
                                  uint32_t i4) {
...
constexpr static uint32_t whisky5alt(uint32_t i0, uint32_t i1, uint32_t i2, uint32_t i3,
                                     uint32_t i4) {
...
constexpr static uint32_t whisky5alt2(uint32_t i0, uint32_t i1, uint32_t i2, uint32_t i3,
                                      uint32_t i4) {
...
constexpr static void whiskySha256(const uint32_t input[8], uint32_t output[8]) {
  const uint32_t k[64] = {
  ...
  uint32_t x, y, m[64] = { input[0], input[1], input[2],   input[3], input[4], input[5],
                           input[6], input[7], 0x80000000, 0,        0,        0,
                           0,        0,        0,          0x100 };
...
constexpr static float whiskyf(uint32_t a) {
  uint32_t i = 0x3F800000 | (a >> 9);
  float    f = std::bit_cast<float>(i);
  return f - 1.0f;
}

// generates doubles ranging [0, 1) using 52 bits of randomness passed in
constexpr static double whiskyd(uint32_t a, uint32_t b) {
  uint64_t m = a;
  m          = (m << 20) | (b >> 12);
  union {
    uint64_t i;
    double   d;
  } u = { .i = (UINT64_C(0x3FF) << 52) | m };
  return u.d - 1.0;
}

// convenience wrappers
constexpr static float  whisky1f(uint32_t i0) { return whiskyf(whisky1(i0)); }
constexpr static double whisky1d(uint32_t i0) {
  return whiskyd(whisky1(i0), whisky1alt(i0));
}
constexpr static float whisky2f(uint32_t i0, uint32_t i1) {
  return whiskyf(whisky2(i0, i1));
}
constexpr static double whisky2d(uint32_t i0, uint32_t i1) {
  return whiskyd(whisky2(i0, i1), whisky2alt(i0, i1));
}
constexpr static float whisky3f(uint32_t i0, uint32_t i1, uint32_t i2) {
  return whiskyf(whisky3(i0, i1, i2));
}
constexpr static double whisky3d(uint32_t i0, uint32_t i1, uint32_t i2) {
  return whiskyd(whisky3(i0, i1, i2), whisky3alt(i0, i1, i2));
}
constexpr static float whisky4f(uint32_t i0, uint32_t i1, uint32_t i2, uint32_t i3) {
  return whiskyf(whisky4(i0, i1, i2, i3));
}
constexpr static double whisky4d(uint32_t i0, uint32_t i1, uint32_t i2, uint32_t i3) {
  return whiskyd(whisky4(i0, i1, i2, i3), whisky4alt(i0, i1, i2, i3));
}
constexpr static float whisky5f(uint32_t i0, uint32_t i1, uint32_t i2, uint32_t i3,
                                uint32_t i4) {
  return whiskyf(whisky5(i0, i1, i2, i3, i4));
}
constexpr static double whisky5d(uint32_t i0, uint32_t i1, uint32_t i2, uint32_t i3,
                                 uint32_t i4) {
