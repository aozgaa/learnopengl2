...
const char *cubeFragmentShaderPath  = "src/2.5.1.casters_direction_cube.frag";
...
int main() {
  ...
  while (!glfwWindowShouldClose(window)) {
    ...
    auto direction  = glm::vec3(-0.2f, -1.0f, -0.3f); //-lightPos;
    ...
    glUniform3f(cube.locs.light.direction, direction.x, direction.y, direction.z);
