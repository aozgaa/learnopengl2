...
constexpr int EMISSION_TEXTURE_UNIT = 2;
...
const char *cubeFragmentShaderPath  = "src/2.4.6.maps_ex4_emission_cube.frag";
...
int main() {
  ...
  while (!glfwWindowShouldClose(window)) {
    ...
    glBindTexture(GL_TEXTURE_2D, cube.emissionTexture);
...
void CubeContext::reload() {
  ...
  locs.material.emission  = glGetUniformLocation(program, "material.emission");
  ...
  glUniform1i(locs.material.emission, EMISSION_TEXTURE_UNIT);
